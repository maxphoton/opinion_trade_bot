...
def parse_market_url(url: str) -> Tuple[Optional[int], Optional[str], Optional[str]]:
...
async def resolve_market_by_slug(
    ...
    try:
        ...
        logger.error(f"Unexpected error resolving market slug '{slug}': {e}")
        return None, None
